...
module.exports.setRouter = (app)=>{
    ...
    app.get(`/auth/google/callback` ,passport.authenticate('google'),(req, res)=>{
        ...
        responseHTML = responseHTML.replace('%value%', JSON.stringify({user: req.user}));
    ...
    app.get('/api/logout', (req, res)=>{res.send(req.logout()) /*console.log(req.logout())*/})
    ...
    app.get('/api/watcher/:issueId',issueController.getIssueWatcher)
